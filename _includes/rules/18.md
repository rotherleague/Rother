...
| Age on 31 August of the relevant Playing Season	| Eligible Age Groups	| Maximum Permitted Format	 | Minimum Pitch Sizes	| Minimum Pitch Sizes	| Maximum Pitch Sizes |  Maximum Pitch Sizes | Recommended Goal Sizes in feet	| Ball Size |
|----|----------|-------|----------|---------------|-----------|---------------|---------|---|
| Age  | Groups |       | Yards    | Metres        | Yards     | Metres        |         |   |	
